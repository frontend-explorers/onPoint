...
## <img width="30" src="https://github.com/FED-EPAM/onPoint/blob/master/assets/next.png?raw=true"> <span style="display: block; margin-top: -36px; padding-left: 45px;">Next Event</span>
